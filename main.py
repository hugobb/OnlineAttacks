...
import ipdb
import sys
from attacks import data_and_model_setup, load_data
from attacks import eval as eval_attacker
import wandb
import torch
...
from attacks.attack_helpers import Linf_dist, L2_dist, ce_loss_func, save_image_to_wandb
from attacks.attack_helpers import attack_ce_loss_func, carlini_wagner_loss, non_saturating_loss, targeted_cw_loss
...
def main():
    ...
    parser.add_argument('--N', type=int, default=5, metavar='K',
    ...
    parser.add_argument('--online_type', type=str, default='offline')
    ...
    offline_algorithm, online_algorithm = create_online_algorithm(args, args.online_type, args.N, args.K)
    if args.dataset == 'toy':
        ...
        comp_ratio = comp_ratio / (args.K*num_perms)
        print("Competitive Ratio is %f " %(comp_ratio))
