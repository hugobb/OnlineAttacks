...
def load_cifar_dataset(params: DatasetParams = DatasetParams(), train: bool = True) -> CIFAR10:
    ...
    return CIFAR10(root=params.data_dir, train=train, transform=transform, download=params.download)


def create_cifar_loaders(params: DatasetParams = DatasetParams()) -> (DataLoader, DataLoader):
