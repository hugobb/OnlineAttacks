from online_attacks.classifiers import AttackerConfig, ModelParams, CifarModel, MnistModel, eval_classifier, DatasetType
...
attacker = AttackerConfig(attacker=args.attacker, model=ModelParams(model_type=args.source_model_type, model_name=args.source_model_name))
...
model = ModelParams(model_type=args.target_model_type, model_name=args.target_model_name)
